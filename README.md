...
Notes:
- paths and min coverage changed files have to be able to connect to define separated min values
- modules - list of modules and their paths from root - like context/neco - TODO
...
TODO
TBD - the IDs of generated comments ?
  - multiple ids
TBD - the overall numbers of coverage ?
  - coverage-overall - %
