...
# in scan is not defined module and its reports - removed 'module_large'
modules_missing = {
    "context/notification": 'test_project/context/notification',
    "context/user-info": 'test_project/context/user-info',
    "module small": 'test_project/module small',
...
# related to modules_missing
modules_thresholds_missing = {
    "context/notification": (22.0, 60.0),
    "context/user-info": (21.0, 59.0),
    "module small": (29.0, 37.0),
}
...
more_source_files_scenarios = [
    ...
    # ("54", CommentModeEnum.MODULE, SensitivityEnum.DETAIL, modules_missing, modules_thresholds, changed_files, comment_module_detail_instruction_with_modules, 9, 4, [], False, False),   # TODO - missing module definition
]
